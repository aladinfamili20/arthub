...
const ProfGoldFetchCol = (collectionName) => {
  const [goldArtworks, setGold] = useState([]);
    ...
    onAuthStateChanged(auth, (user)=>{
      if (user){
        ...
        const fetchArtist = async () => {
          ...
          setGold([{...docSnap.data(), id: docSnap.id}]);
        };
        fetchArtist();
  ...
  return { goldArtworks, isLoading };
};

export default ProfGoldFetchCol;
